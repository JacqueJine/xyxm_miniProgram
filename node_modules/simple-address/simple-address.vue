		...
		<view class="simple-address-content simple-address--fixed" :class="[type, ani + '-content', animation ? 'content-ani' : '']">
			<view class="simple-address__header">
				...
				<view class="simple-address__header-btn-box" @click="pickerConfirm">
					<text class="simple-address__header-text" :style="{
	...
	export default {
		...
		methods: {
			...
			queryIndex(params = [], type = "value") {
				...
				// 1.获取省份的index
				let provinceIndex = this.provinceData.findIndex(
					(res) => res[type] == params[0]
				);
				let cityIndex = this.cityData[provinceIndex].findIndex(
					(res) => res[type] == params[1]
				);
				let areaIndex = this.areaData[provinceIndex][cityIndex].findIndex(
